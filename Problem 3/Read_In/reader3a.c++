...
int main()
{
  ...
  ifstream fp("potentialarrayA.txt");
  ...
  ifstream fp2("maskarrayA.txt");		//read in masked array
  for (int i=0; i<max_x; i++){			
    for(int j=0; j<max_y; j++){
  ...
  cout << "Data stored in reader3a.dat"<< endl;
  myfile.close();
